...
#define GTK_DISTORTIONPLUS_KNOB_GET_PRIVATE(obj) (G_TYPE_INSTANCE_GET_PRIVATE((obj), GTK_TYPE_DISTORTIONPLUS_KNOB, GtkDistortionPlusKnobPrivate))

G_DEFINE_TYPE(GtkDistortionPlusKnob, gtk_knob, GTK_TYPE_RANGE);

typedef struct _GtkDistortionPlusKnobPrivate GtkDistortionPlusKnobPrivate;

struct _GtkDistortionPlusKnobPrivate
{
    int knob_x;
    int knob_y;
    int knob_step;
...
static void knob_expose(GtkWidget *widget, int knob_x, int knob_y, GdkEventExpose *event, int arc_offset)
{
    /** check resize **/
    int grow;
    GtkDistortionPlusKnobPrivate *priv = GTK_DISTORTIONPLUS_KNOB_GET_PRIVATE(widget);
    ...
    if (priv->model != 3) {
        ...
        GtkDistortionPlusKnob *knob = GTK_DISTORTIONPLUS_KNOB(widget);
...
{
    g_assert(GTK_IS_DISTORTIONPLUS_KNOB(widget));
    GtkDistortionPlusKnob *knob = GTK_DISTORTIONPLUS_KNOB(widget);
    GtkDistortionPlusKnobPrivate *priv = GTK_DISTORTIONPLUS_KNOB_GET_PRIVATE(knob);
...
{
    GtkDistortionPlusKnob *knob = GTK_DISTORTIONPLUS_KNOB(object);
...
/****************************************************************
 ** init the GtkDistortionPlusKnobClass
 */

static void gtk_knob_class_init (GtkDistortionPlusKnobClass *klass)
{
...
//--------- connect the events with funktions
    ...
    g_type_class_add_private(obj_class, sizeof (GtkDistortionPlusKnobPrivate));
}
...
static void gtk_knob_init (GtkDistortionPlusKnob *knob)
{
...
{
    GtkWidget *widget = GTK_WIDGET( g_object_new (GTK_TYPE_DISTORTIONPLUS_KNOB, NULL ));
